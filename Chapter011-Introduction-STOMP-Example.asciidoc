...
[[img_example_app_1]]
.Diagram of the +Locations+ application with two devices, +AAA+ and +BBB+, and one Web application.
image::images/Chapter011/stomp_app_diagram_1.png["Diagram of the Locations application with two devices, AAA and BBB, and one Web application"]

...
These information depends on the broker you are using. If you have configured ActiveMQ as described in the appendix on your machine, we can connect to it using **`localhost`** as its host and **`61613`** as its port.

...
image::images/Chapter030/control_center.png["The Control Center Web application"]
...
image::images/Chapter030/truck_freeway_drive.png["Following a truck on a freeway drive"]
...
[[img_web_stomp_3]]
.Send an order to a truck.
image::images/Chapter030/send_order.png["Send an order to a truck"]
...
image::images/Chapter030/mobile_app_received_order.png["The mobile application received the order"]

...
Its most interesting features are its compactness (reducing bandwidth and memory usage) and its small set of features (making it available on many platforms).
